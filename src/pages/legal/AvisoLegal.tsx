        ...
        <div className="space-y-8 text-sm leading-relaxed">
          ...
          <section>
            ...
            <div className="bg-slate-900 rounded-xl p-4 space-y-2 text-slate-300">
              ...
              <p><span className="text-slate-500">Correo electrónico:</span> {COMPANY.email}</p>
            </div>
          </section>
          ...
          <section>
            <h2 className="text-base font-semibold text-white mb-3 border-b border-slate-800 pb-2">4. Condiciones de uso</h2>
            <p className="text-slate-300 mb-2">
              El acceso y uso de {COMPANY.product} implica la aceptación plena de las presentes condiciones. El usuario se compromete a:
            </p>
            <ul className="list-disc list-inside text-slate-300 space-y-1">
              <li>Hacer un uso lícito de la aplicación, conforme a la ley y buena fe.</li>
              <li>No ceder sus credenciales de acceso a terceros.</li>
              <li>No introducir datos falsos, erróneos o de terceros sin su consentimiento.</li>
              <li>No realizar acciones que puedan dañar, inutilizar o sobrecargar la aplicación.</li>
          ...
          <section>
            <h2 className="text-base font-semibold text-white mb-3 border-b border-slate-800 pb-2">6. Uso de Inteligencia Artificial — Reglamento (UE) 2024/1689</h2>
            <p className="text-slate-300 mb-2">
              {COMPANY.product} incorpora funcionalidades asistidas por Inteligencia Artificial (extracción de datos de negocios desde Google Places, sugerencias de leads). De conformidad con el <strong className="text-white">Reglamento (UE) 2024/1689 sobre Inteligencia Artificial (EU AI Act)</strong>:
            </p>
            <ul className="list-disc list-inside text-slate-300 space-y-1">
              <li>El sistema de IA está clasificado como <strong className="text-white">riesgo bajo</strong> (herramienta de apoyo a la decisión comercial, sin automatización de decisiones con efectos jurídicos sobre personas).</li>
              <li>Ninguna decisión relativa a personas físicas se adopta de forma exclusivamente automatizada sin supervisión humana.</li>
              <li>Los datos empleados por los modelos de IA son datos comerciales de empresas (no datos personales sensibles).</li>
              <li>El usuario es siempre informado de qué funcionalidades utilizan asistencia de IA.</li>
            </ul>
          </section>

          <section>
            <h2 className="text-base font-semibold text-white mb-3 border-b border-slate-800 pb-2">7. Legislación aplicable y jurisdicción</h2>
            <p className="text-slate-300">
              Las presentes condiciones se rigen por la legislación española. Para la resolución de cualquier controversia derivada del uso de la aplicación, las partes se someten a los Juzgados y Tribunales de <strong className="text-white">Santa Cruz de Tenerife</strong>, con renuncia expresa a cualquier otro fuero que pudiera corresponderles.
            </p>
          </section>
