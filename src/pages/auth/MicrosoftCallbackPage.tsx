/**
 * Página de callback para OAuth de Microsoft
        ...
        {isLoading || status === 'processing' ? (
          ...
          <>
            ...
            <p className="text-gray-500 mb-4">
              {error || 'No se pudo completar la autenticación con Microsoft'}
            </p>
          ...
          <>
            ...
            <p className="text-gray-500">Microsoft conectado exitosamente</p>
          </>
        )}
      </div>
    </div>
