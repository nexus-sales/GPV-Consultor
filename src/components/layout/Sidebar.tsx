...
const sidebarItems: SidebarItem[] = [
  {
    ...
    activeClasses:
      'bg-indigo-50 dark:bg-indigo-950/50 text-indigo-700 dark:text-indigo-300 ring-1 ring-indigo-200 dark:ring-indigo-800/50',
    iconActiveClasses:
      'bg-indigo-100 dark:bg-indigo-900/70 text-indigo-600 dark:text-indigo-300',
    iconInactiveClasses:
      'bg-gray-100 dark:bg-gray-800/60 text-gray-500 group-hover:bg-indigo-100 dark:group-hover:bg-indigo-900/50 group-hover:text-indigo-600 dark:group-hover:text-indigo-300',
  ...
  },
  {
    ...
    activeClasses:
      'bg-amber-50 dark:bg-amber-950/50 text-amber-700 dark:text-amber-300 ring-1 ring-amber-200 dark:ring-amber-800/50',
    iconActiveClasses:
      'bg-amber-100 dark:bg-amber-900/70 text-amber-600 dark:text-amber-300',
    iconInactiveClasses:
      'bg-gray-100 dark:bg-gray-800/60 text-gray-500 group-hover:bg-amber-100 dark:group-hover:bg-amber-900/50 group-hover:text-amber-600 dark:group-hover:text-amber-300',
  ...
  },
  {
    ...
    activeClasses:
      'bg-blue-50 dark:bg-blue-950/50 text-blue-700 dark:text-blue-300 ring-1 ring-blue-200 dark:ring-blue-800/50',
    iconActiveClasses:
      'bg-blue-100 dark:bg-blue-900/70 text-blue-600 dark:text-blue-300',
    iconInactiveClasses:
      'bg-gray-100 dark:bg-gray-800/60 text-gray-500 group-hover:bg-blue-100 dark:group-hover:bg-blue-900/50 group-hover:text-blue-600 dark:group-hover:text-blue-300',
  ...
  },
  {
    ...
    activeClasses:
      'bg-cyan-50 dark:bg-cyan-950/50 text-cyan-700 dark:text-cyan-300 ring-1 ring-cyan-200 dark:ring-cyan-800/50',
    iconActiveClasses:
      'bg-cyan-100 dark:bg-cyan-900/70 text-cyan-600 dark:text-cyan-300',
    iconInactiveClasses:
      'bg-gray-100 dark:bg-gray-800/60 text-gray-500 group-hover:bg-cyan-100 dark:group-hover:bg-cyan-900/50 group-hover:text-cyan-600 dark:group-hover:text-cyan-300',
  ...
  },
  {
    ...
    activeClasses:
      'bg-rose-50 dark:bg-rose-950/50 text-rose-700 dark:text-rose-300 ring-1 ring-rose-200 dark:ring-rose-800/50',
    iconActiveClasses:
      'bg-rose-100 dark:bg-rose-900/70 text-rose-600 dark:text-rose-300',
    iconInactiveClasses:
      'bg-gray-100 dark:bg-gray-800/60 text-gray-500 group-hover:bg-rose-100 dark:group-hover:bg-rose-900/50 group-hover:text-rose-600 dark:group-hover:text-rose-300',
  ...
  },
  {
    ...
    activeClasses:
      'bg-emerald-50 dark:bg-emerald-950/50 text-emerald-700 dark:text-emerald-300 ring-1 ring-emerald-200 dark:ring-emerald-800/50',
    iconActiveClasses:
      'bg-emerald-100 dark:bg-emerald-900/70 text-emerald-600 dark:text-emerald-300',
    iconInactiveClasses:
      'bg-gray-100 dark:bg-gray-800/60 text-gray-500 group-hover:bg-emerald-100 dark:group-hover:bg-emerald-900/50 group-hover:text-emerald-600 dark:group-hover:text-emerald-300',
  ...
  },
  {
    ...
    activeClasses:
      'bg-violet-50 dark:bg-violet-950/50 text-violet-700 dark:text-violet-300 ring-1 ring-violet-200 dark:ring-violet-800/50',
    iconActiveClasses:
      'bg-violet-100 dark:bg-violet-900/70 text-violet-600 dark:text-violet-300',
    iconInactiveClasses:
      'bg-gray-100 dark:bg-gray-800/60 text-gray-500 group-hover:bg-violet-100 dark:group-hover:bg-violet-900/50 group-hover:text-violet-600 dark:group-hover:text-violet-300',
  ...
  },
  {
    ...
    activeClasses:
      'bg-sky-50 dark:bg-sky-950/50 text-sky-700 dark:text-sky-300 ring-1 ring-sky-200 dark:ring-sky-800/50',
    iconActiveClasses:
      'bg-sky-100 dark:bg-sky-900/70 text-sky-600 dark:text-sky-300',
    iconInactiveClasses:
      'bg-gray-100 dark:bg-gray-800/60 text-gray-500 group-hover:bg-sky-100 dark:group-hover:bg-sky-900/50 group-hover:text-sky-600 dark:group-hover:text-sky-300',
  ...
  },
  {
    ...
    activeClasses:
      'bg-teal-50 dark:bg-teal-950/50 text-teal-700 dark:text-teal-300 ring-1 ring-teal-200 dark:ring-teal-800/50',
    iconActiveClasses:
      'bg-teal-100 dark:bg-teal-900/70 text-teal-600 dark:text-teal-300',
    iconInactiveClasses:
      'bg-gray-100 dark:bg-gray-800/60 text-gray-500 group-hover:bg-teal-100 dark:group-hover:bg-teal-900/50 group-hover:text-teal-600 dark:group-hover:text-teal-300',
  ...
  },
  {
    ...
    activeClasses:
      'bg-slate-100 dark:bg-slate-800/70 text-slate-700 dark:text-slate-200 ring-1 ring-slate-200 dark:ring-slate-700/50',
    iconActiveClasses:
      'bg-slate-200 dark:bg-slate-700 text-slate-600 dark:text-slate-200',
    iconInactiveClasses:
      'bg-gray-100 dark:bg-gray-800/60 text-gray-500 group-hover:bg-slate-200 dark:group-hover:bg-slate-700 group-hover:text-slate-600 dark:group-hover:text-slate-200',
...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    ...
    >
      {/* Logo Section */}
      <div
        className={`p-6 border-b border-gray-100 dark:border-gray-800 ${collapsed ? 'px-3' : ''}`}
      >
        <div
      ...
      {/* Navigation Section */}
      <nav
        className={`flex-1 overflow-y-auto custom-scrollbar ${collapsed ? 'p-2' : 'p-3 lg:p-4'} space-y-1`}
      >
        {!collapsed && (
        ...
        {sidebarItems.map((item) => {
          ...
          return (
            ...
            >
              ...
              {isActive && !collapsed && (
                <div
                  className={`w-2 h-2 rounded-full shrink-0 ${item.dotClasses}`}
                ></div>
              )}
            </Link>
          )
      ...
      <div
        className={`p-4 border-t border-gray-100 dark:border-gray-800 ${collapsed ? 'items-center' : ''}`}
      >
        {!collapsed && (
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-[10px] text-gray-500 dark:text-gray-500 leading-tight">
                  Soporte 24/7 disponible para el equipo
                </p>
              </div>
            </div>
          </div>
      ...
      >
        <ChevronDownIcon
          className={`h-4 w-4 transition-transform duration-500 ${collapsed ? '-rotate-90' : 'rotate-90'}`}
        />
      </button>
    </aside>
  )
