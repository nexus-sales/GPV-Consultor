          ...
          <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-2xl w-full max-w-md">
            ...
            <div className="p-6 space-y-4">
              <p className="text-sm text-slate-600 dark:text-slate-400">
                Se crear├í un distribuidor en estado{' '}
              ...
              <div className="bg-slate-50 dark:bg-slate-800 rounded-lg p-3 text-sm space-y-1">
                ...
                {convertContact.poblacion && (
                  <p>
                    <span className="text-slate-500">Poblaci├│n:</span>{' '}
                    {convertContact.poblacion}
                  </p>
                )}
              ...
              <p className="text-xs text-slate-400">
                El estado del contacto Backoffice pasar├í a{' '}
                <strong>COLABORA</strong> autom├íticamente.
              </p>
            </div>
      ...
      {visitContact && (
        ...
        >
          <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-2xl w-full max-w-md">
            ...
            <div className="p-6 space-y-4">
              <p className="text-sm text-slate-600 dark:text-slate-400">
                La visita quedar├í registrada en el{' '}
                <strong>m├│dulo Visitas</strong> y la fecha se actualizar├í en
                este contacto.
              </p>
              <div>
                <label className="block text-xs font-semibold text-slate-600 dark:text-slate-400 mb-1 uppercase tracking-wide">
